  ...
  <div class="content-wrapper">
   ...
   <!-- Content Header (Page header) -->
	...
	<section class="content">
				...
				<div class="col-xs-12">
				<form method="POST" action="" name ="add_form" id="add_form" role= "form" data-toggle="validator" data-disable="false" accept-charset="UTF-8" class="form-inline" >
						<input type="hidden" value="" name="id" class="optional"/>
						
						<div class="row mtop-23">
						<div class="col-md-3 pb-15">
						<label class="title-label"> Add </label>
						</div>
						<div class="col-md-7">
				...
				<div class="row">
					<div class="col-md-12">
						<button class="btn article-btn" id="btnEdit" onClick="edit();">Save</button>	
					</div>
				</div>			
