   ...
   <!-- Content Header (Page header) -->
	...
	<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"> Add Roundup</li>
      </ol>
    </section>
	...
	<section class="content">
				...
				<form method="POST" action="" name ="add_form" id="add_form" role= "form" data-toggle="validator" data-disable="false" accept-charset="UTF-8" >
						...
						<div class="col-md-4">
							<input type="text" class="input-title form-control" id="head" name="head" style="width:300px; height:40px;"placeholder="Title"/>
						</div>
						<div class="col-md-5">
						...
						<div class="col-md-5">
                            ...
                            <div class="col-md-7">
                               <input type="text" id="URL" name="URL" class="input-title form-control" placeholder="Youtube Short URL" style="width:200px; height:40px;">
                                <span class='label label-info' id="upload-file-info"></span>
		...
		function edit()
		{
			...
			$('#lanid').removeClass('has-error');
				...
				if(!hasErrors){
					...
					var URL ="<?php echo base_url();?>index.php/" +"/CinemaAd/saveRoundUp";
