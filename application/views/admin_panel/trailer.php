 ...
 <?php include 'header.php';?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <button class="btn btn-success" onClick="addData();"><i class="glyphicon glyphicon-plus"></i>   Add Trailer </button>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Trailer  List</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <form action="#" id="form" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="Film_Id" id="Film_Id" placeholder="Film " class="form-control required" required type="hidden" value="<?php echo $latestreleaseid?>" readonly>
					...
					<div class="form-group">
                            <label for="Trailer Link" class="control-label col-md-3">Trailer Link*</label>
                            <div class="col-md-9">
...
<script type="text/javascript" src="<?php echo base_url(); ?>js/admin/trailer.js"></script>
