...
var save_method; //for save method string
    ...
    table = $('#dataTable').DataTable({ 
        ...
        "ajax": {
            "url": BASE_URL + "index.php/" + ADMIN_CONTROLLER +"/castcrewList/" +latestreleaseid, //<?php echo site_url('person/ajax_list')?>
            "type": "POST",
...
{
    var EDIT_URL  =  $("#hidBASE_URL").val() + "index.php/" + ADMIN_CONTROLLER + "/getEditCastcrew";
    ...
    $.ajax({
        ...
        success: function(data)
        {
           ...
           // $('[name="Retype_Password"]').val("xxxxxxxxxxxxxx");
            ...
            $('.modal-title').text('Edit Cast and Crew'); // Set title to Bootstrap modal title
...
var formUtils = {
    ...
    if(save_method == 'add') {
        ...
        url = $("#hidBASE_URL").val() + "index.php/" + ADMIN_CONTROLLER + "/saveCastcrew";
    } 
...
function deleteData(id)
{
    ...
    bootbox.confirm({
        ...
        $.ajax({
            url : $("#hidBASE_URL").val() + "index.php/" + ADMIN_CONTROLLER + "/deleteCastcrew/"+id,
            type: "POST",
            dataType: "text",
