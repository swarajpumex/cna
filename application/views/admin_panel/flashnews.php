 ...
 <?php include 'header.php';?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <button class="btn btn-success" onClick="addData();"><i class="glyphicon glyphicon-plus"></i> Add FlashNews</button>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">FlashNews</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Add FlashNews</h3>
                ...
                <form action="#" id="form" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label for="User_Id" class="control-label col-md-3">FlashNews*</label>
                            <div class="col-md-9">
                                <input name="FlashNews" id="FlashNews" placeholder="FlashNews" class="form-control required" required type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <!--<div class="form-group">-->
                        <!--    <label for="User_Id" class="control-label col-md-3">Link*</label>-->
                        <!--    <div class="col-md-9">-->
                        <!--        <input name="Link" id="Link" placeholder="Link" class="form-control required" required type="text">-->
                        <!--        <span class="help-block"></span>-->
                        <!--    </div>-->
                        <!--</div>-->
...
<script type="text/javascript" src="<?php echo base_url(); ?>js/admin/flashnews.js"></script>
