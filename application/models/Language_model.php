...
class Language_model extends CI_Model {
	...
	var $table = 'language';
        ...
        var $column_order = array('Language','CreatedOn','Status'); //set column field database for datatable orderable
	var $column_search = array('Language','Status'); //set column field database for datatable searchable.
