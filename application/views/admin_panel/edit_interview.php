   ...
   <!-- Content Header (Page header) -->
	...
	<section class="content">
				...
				<form method="POST" action="" name ="add_form" id="add_form" role= "form" data-toggle="validator" data-disable="false" accept-charset="UTF-8" >
						...
						<label class="title-label"> Add Interview Title</label>
						</div>
						<div class="col-md-4">
							<input type="text" class="input-title form-control" id="head" name="head" style="width:300px; height:40px;"placeholder="Interview Title" value="<?php echo $interview['Title'];?>"/>
						</div>
						<div class="col-md-5">
						...
						<div class="col-md-4">
							...
							<textarea  rows="4" cols="50" maxlength="200"  id="details" name="details" class="input-title form-control" placeholder="Details"><?php echo $interview['Description'];?></textarea>
						...
						<div class="col-md-5">
                            ...
                            <div class="col-md-7">
                               <input type="text" id="URL" name="URL" class="input-title form-control" placeholder="Youtube Short URL" style="width:200px; height:40px;" value="<?php echo $interview['Link'];?>">
                                <span class='label label-info' id="upload-file-info"></span>
						...
						<div class="col-md-5">
                            ...
                            <label for="userfile" class="control-label col-md-5">Unique Name</label>
                            <div class="col-md-7">
                               <input name="UniqueName" id="UniqueName" placeholder="Unique Name" class="form-control required" value="<?php echo $interview['UniqueName'];?>" required type="text" style="width:200px; height:40px;">
						...
						<?php require_once('common-hid-fields.php');?>
							<div class="form-group">
								...
								<div class="box-body pad">
									...
									//	$aboutUsText = str_replace('\"','"',$aboutUsText);
									?>
									<textarea id="editor" name="editor" rows="20" cols="80" style="height:80px !important;"><?php echo $interview['Details'];?>
...
<script>
		...
		$(function () {
				  ...
				  CKEDITOR.replace('editor', {
					     filebrowserUploadUrl: "<?php echo base_url();?>CinemaAd/upload",
		...
		function edit()
		{
			...
			$('#lanid').removeClass('has-error');
				...
				if(!hasErrors){
					...
					var URL ="<?php echo base_url();?>index.php/" +"/CinemaAd/editInterviews/"+"<?php echo $interview['Id'];?>"
