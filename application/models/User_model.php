...
class User_model extends CI_Model {
	...
	var $table = 'login';
        ...
        var $column_order = array('UserId','UserType','Status'); //set column field database for datatable orderable
	var $column_search = array('UserId','UserType', 'Status'); //set column field database for datatable searchable.
