...
var save_method; //for save method string
    ...
    table = $('#dataTable').DataTable({ 
        ...
        "ajax": {
            "url": BASE_URL + "index.php/" + ADMIN_CONTROLLER +"/songList/" +latestreleaseid, //<?php echo site_url('person/ajax_list')?>
            "type": "POST",
...
{
    var EDIT_URL  =  $("#hidBASE_URL").val() + "index.php/" + ADMIN_CONTROLLER + "/getEditSong";
    ...
    $.ajax({
	    ...
	    $('[name="hidID"]').val(data.Id);
            ...
            $('[name="Film_Id"]').val(data.FilmId);
			  ...
			  $('[name="Song_Name"]').val(data.SongName);
			$('[name="URL"]').val(data.Link);
           ...
           // $('[name="Retype_Password"]').val("xxxxxxxxxxxxxx");
            ...
            $('.modal-title').text('Edit SongLink'); // Set title to Bootstrap modal title
...
var formUtils = {
    ...
    if(save_method == 'add') {
        ...
        url = $("#hidBASE_URL").val() + "index.php/" + ADMIN_CONTROLLER + "/saveSong";
    } 
...
function deleteData(id)
{
    ...
    bootbox.confirm({
        ...
        $.ajax({
            url : $("#hidBASE_URL").val() + "index.php/" + ADMIN_CONTROLLER + "/deleteSong/"+id,
            type: "POST",
            dataType: "text",
