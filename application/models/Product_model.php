...
class Product_model extends CI_Model {
	...
	var $table = 'product';
        ...
        var $column_order = array('ProductName','Price','Details','Status'); //set column field database for datatable orderable
	var $column_search = array('ProductName','Category', 'Status'); //set column field database for datatable searchable.
 ...
 private function getDataTableQuery()
	{
		...
		//$this->db->where("ProductName !=","shameel");
		$i = 0;
 ...
 function countFiltered()
	...
	public function deleteData($id)
	{
                ...
                */
                ...
                // deleting the Profile photo
              /* $upload_dir ='./uploads/product_image/'; // upload directory
                $photo = $db->getFieldValueById($this->table, "ProductPhoto ", "Id='{$id}'");
