...
<head>
   ...
   <style>
      .rvws-content .shortfilm-details p {
         margin: 0 0 0.35em;
         line-height: 1.45;
         font-size: 16px;
      }

      .rvws-content .shortfilm-details iframe,
      .rvws-content .shortfilm-details .social-video-embed {
         width: 100%;
         min-height: 360px;
         border: 0;
         display: block;
      ...
      .rvws-content .shortfilm-details .social-video-embed-instagram {
         min-height: 620px;
      }
               ...
               <div class="Portfolios col-md-4">
                  <div class="revw-bx">
                     ...
                     <div class="rvws-content">
                        ...
                        <div class="shortfilm-details"><?php echo html_entity_decode(stripslashes((string) $val['Details']), ENT_QUOTES, 'UTF-8'); ?></div>
