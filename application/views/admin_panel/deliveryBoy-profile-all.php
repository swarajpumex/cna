  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Delivery Boy Profile All</li>
      </ol>
    </section>
    ...
    <section class="content">
		<div class="container">
                    ...
                    <h1 class="h2">All Delivery Boys| <a class="btn btn-default" href='<?php echo base_url("$adminController/deliveryBoy");?>' <span class="glyphicon glyphicon-backward"></span> &nbsp; Go back to list </a></h1> 
                    </div>
                            ...
                            if($userPic==NULL  || $userPic="")
                                {
                                 ...
                                 $userPic  = base_url()."uploads/profile_image/" . $row["Photo"];
                            ?>
                                <div class="col-xs-3">
                                    <p class="page-header" style="font-size: 2vmin;"><?php echo $row["Name"]."&nbsp;/&nbsp;".$row["Status"] ; ?></p>
				...
				<p class="page-header">
				<span>
				<a style="font-size: 2vmin;" class="btn btn-info" name ="<?php echo $row['Photo'];?>" id="edit_<?php echo $row['Id'];?>" href="#" title="click to edit photo" onclick="return confirmEdit(this.name, this.id);"><span class="glyphicon glyphicon-edit"></span>Edit</a> 
...
<script>
    ...
    $("#btnSave").click(function (){
      ...
      if (typeof FormData == 'undefined')
       ...
       var URL =$("#hidBASE_URL").val() + "index.php/" + ADMIN_CONTROLLER +  "/editDeliveryBoyPhoto";
 ...
 function confirmDelete(id)
{
   ...
   // return;
     ...
     if(result)
	{
        ...
        $.ajax({
            url : $("#hidBASE_URL").val() + "index.php/" + ADMIN_CONTROLLER + "/deleteDeliveryBoyPhoto/"+id[1],
            type: "POST",
            dataType: "text",
