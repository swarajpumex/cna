...
class Roundup_model extends CI_Model {

	var $table = 'roundup';

        var $column_order = array('Title','Link','CreatedOn','Status'); //set column field database for datatable orderable
	var $column_search = array('Title','Status'); //set column field database for datatable searchable.
