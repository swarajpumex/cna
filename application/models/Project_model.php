...
class Project_model extends CI_Model {
	...
	var $table = 'project';
        ...
        var $column_order = array('ProjectName','Details','Status'); //set column field database for datatable orderable
	var $column_search = array('ProjectName','Status'); //set column field database for datatable searchable.
