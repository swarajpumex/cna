...
<html lang="en">
  ...
  <body>
    ...
    foreach ($lan as $row):
        ...
        echo '<li class="'.$tab_class.'"><a href="#' . urlencode($row['Language']) .  '" data-toggle="tab">' .           
        $row['Language'] .  ' </a></li>';
    endforeach;
    ?>
...
<div class="tab-content" id="pills-tabContent">
	    <div class="tab-pane fade show active" id="showall" role="tabpanel" aria-labelledby="showall-tab">
			...
			<?php foreach ($film as $val) { ?>
				<div class="Portfolio col-md-3">
				   ...
				   <div class="desc"><a href="detail.php"><?php echo $val['FilmName'];?><span>"<?php echo $val['Language'];?></span></a></div>
        ...
        <?php foreach ($lan as $row2)
        $tab = $row2['Language'];
        //set the class to "active" for the active content.
        $content_class = ($tab==$current_tab) ? 'active' : '' ;
        ?>
		
	<div class="tab-pane <?php echo $content_class;?>" id="<?php echo $tab;?>" role="tabpanel" aria-labelledby="Cars-tab">
		<div class="row justify-content-md-center"> 
		<?php      
                    foreach($film as $fl) 
					{
              ...
              if($fl['Language'] == $tab)
			            {
							?>
			<div class="Portfolio latest-bx col-md-3">
				<a href="#!">
				<img class="card-img" src="<?php echo base_url();?>uploads/film_image/<?php echo $val['Photo'];?>"  alt="">
				</a>
				<div class="desc"><a href="#"><?php echo $val['FilmName'];?><span><?php echo $val['Language'];?></span></a></div>
			</div>
						<?php 
