...
<html lang="en">
  ...
  <body>
	...
	<section id="video" class="video clearfix">
								...
								<div class="modal-content">
								  ...
								  <div class="modal-body mb-0 p-0">
									...
									<div class="embed-responsive embed-responsive-16by9 z-depth-1-half">
									  <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/kP4vEzIv2lI"
            ...
            <div class="row justify-content-md-center">
                <div class="col-lg-8 col-md-8">
                    <div class="revw-content-section">
						    <div class="revw-pics">
							<img src="<?php echo base_url();?>img/review-detal/01.jpg" alt="" class="img-fluid">
							</div>
				 ...
				 <div class="col-lg-4 col-md-4">
				   <div class="advtmnt-bx">
						<img src="<?php echo base_url();?>img/advtmnt.jpg" alt="" class="img-fluid">
				   </div>
