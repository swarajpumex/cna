...
var save_method; //for save method string
    ...
    table = $('#dataTable').DataTable({ 
        ...
        "ajax": {
            "url": BASE_URL + "index.php/" + ADMIN_CONTROLLER +"/languageList", //<?php echo site_url('person/ajax_list')?>
            "type": "POST",
...
{
    var EDIT_URL  =  $("#hidBASE_URL").val() + "index.php/" + ADMIN_CONTROLLER + "/getEditLanguage";
...
function deleteData(id)
{
    ...
    bootbox.confirm({
        ...
        $.ajax({
            url : $("#hidBASE_URL").val() + "index.php/" + ADMIN_CONTROLLER + "/deleteLanguage/"+id,
            type: "POST",
            dataType: "text",
