...
var save_method; //for save method string
    ...
    table = $('#dataTable').DataTable({ 
        ...
        "ajax": {
            "url": BASE_URL + "index.php/" + ADMIN_CONTROLLER +"/theaterList/" +latestreleaseid, //<?php echo site_url('person/ajax_list')?>
            "type": "POST",
...
{
    var EDIT_URL  =  $("#hidBASE_URL").val() + "index.php/" + ADMIN_CONTROLLER + "/getEditTheater";
    ...
    $.ajax({
	    ...
	    $('[name="hidID"]').val(data.Id);
			...
			$('[name="Theater_Name"]').val(data.TheaterName);
           ...
           // $('[name="Retype_Password"]').val("xxxxxxxxxxxxxx");
			...
			$('[name="ShowDate"]').val(data.ShowDate);
			$('[name="ShowTime"]').val(data.ShowTime);
			$('[name="Status"]').val(data.Status);
			
			
			$('#modal_form').modal('show'); // show bootstrap modal when complete loaded
            $('.modal-title').text('Edit Theater'); // Set title to Bootstrap modal title
...
var formUtils = {
    ...
    if(save_method == 'add') {
        ...
        url = $("#hidBASE_URL").val() + "index.php/" + ADMIN_CONTROLLER + "/saveTheater";
    } 
...
function deleteData(id)
{
    ...
    bootbox.confirm({
        ...
        $.ajax({
            url : $("#hidBASE_URL").val() + "index.php/" + ADMIN_CONTROLLER + "/deleteTheater/"+id,
            type: "POST",
            dataType: "text",
