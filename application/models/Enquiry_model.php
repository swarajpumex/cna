...
class Enquiry_model extends CI_Model {
	...
	var $table = 'enquiry';
        ...
        var $column_order = array('Name','Place','Email','Phone','Status'); //set column field database for datatable orderable
	var $column_search = array('Name','Place', 'Status'); //set column field database for datatable searchable.
