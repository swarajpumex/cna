         ...
         <div class="row">
             <div class="col-md-9 pr0">
               ...
               <div class="row  mb3">
                  ...
                  <div class="col-xl-8 col-md-8 stretch-card grid-margin">
                     <div class="position-relative">
                         <img src="<?php echo base_url();?>uploads/film_image/<?php echo $val['Photo']; ?>" alt="banner" class="img-fluid" style="margin:0 0 10px 0 "/>
            ...
            <div class="col-md-3">
               ...
               <div class="row">
                  ...
                  <div class="col-md-8 mv-detl">
                       <a href="<?php echo "https://youtube.com/embed/".substr($val['Link'],17);?>"  target="_blank" style="float: left; background: none; color: #000;"><p><?php echo $val['SongName'];?></p></a>
