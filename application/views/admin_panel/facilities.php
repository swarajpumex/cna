    ...
    <section class="content">
        ...
        <div class="row">
			...
			<div class="col-md-3 col-sm-4 popular-listing-box" style="padding:2%;">
				<figure class="effect-ming"><img style="max-height:90%;max-width:100%;" src="<?php echo base_url()."uploads/facilities/".$row['Image'];?>"> <figcaption>
				 <ul>
...
<script type="text/javascript" src="<?php echo base_url(); ?>js/admin/facilities.js"></script>
