 ...
 <?php include 'header.php';?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <button class="btn btn-success" onClick="addData();"><i class="glyphicon glyphicon-plus"></i> Add Category</button>
                ...
                <form action="#" id="form" method="post" class="form-horizontal" enctype="multipart/form-data">
					...
					<div class="form-body">		
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="Category" id="Category" placeholder="Category" class="form-control required" required type="text">
