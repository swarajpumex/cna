...
if (isset($CI->session)) {
  ...
  $profilePhoto = $CI->session->userdata('PROFILE_PHOTO');
}

if (($adminId === FALSE || $adminId === '' || is_null($adminId)) && isset($_SESSION['ADMIN_ID'])) {
  $adminId = $_SESSION['ADMIN_ID'];
}

if (($profilePhoto === FALSE || $profilePhoto === '' || is_null($profilePhoto)) && isset($_SESSION['PROFILE_PHOTO'])) {
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown user user-menu">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            <img src="<?php echo base_url(); ?>uploads/profile_image/<?php echo $profilePhoto; ?>" class="user-image" alt="User Image">
            <span class="hidden-xs"><?php echo $adminId; ?></span>
          </a>
          <ul class="dropdown-menu">
            <!-- User image -->
            <li class="user-header">
              <img src="<?php echo base_url(); ?>uploads/profile_image/<?php echo $profilePhoto; ?>" class="img-circle" alt="User Image">
