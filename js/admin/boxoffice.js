...
$(document).ready(function() {
	...
	//var latestreleaseid = $("#latestreleaseid").val();
...
var save_method; //for save method string
    ...
    table = $('#dataTable').DataTable({ 
        ...
        "ajax": {
            "url": BASE_URL + "index.php/" + ADMIN_CONTROLLER +"/boxofficeList", //<?php echo site_url('person/ajax_list')?>
            "type": "POST",
...
{
    var EDIT_URL  =  $("#hidBASE_URL").val() + "index.php/" + ADMIN_CONTROLLER + "/getEditBoxoffice";
    ...
    $.ajax({
	    ...
	    $('[name="hidID"]').val(data.Id);
             ...
             $('[name="Boxoffice"]').val(data.Boxoffice);
           ...
           // $('[name="Retype_Password"]').val("xxxxxxxxxxxxxx");
            ...
            $('.modal-title').text('Edit Boxoffice Collection'); // Set title to Bootstrap modal title
...
var formUtils = {
    ...
    if(save_method == 'add') {
        ...
        url = $("#hidBASE_URL").val() + "index.php/" + ADMIN_CONTROLLER + "/saveBoxoffice";
    } 
 ...
 if (typeof FormData == 'undefined')
  {
   ...
   // alert(formData);
    ...
    $.ajax({
        ...
        base_url = $("#hidBASE_URL").val() + "index.php/" + ADMIN_CONTROLLER + "/latestRelease";
        window.location.href = base_url;
			// window.location.href = "http://localhost/cinemanews/CinemaAd/latestRelease";
			});
                $btn.val('Save');  
                if(EDIT_ID==0)
                     formUtils.clearForm();               
...
function deleteData(id)
{
    ...
    bootbox.confirm({
        ...
        $.ajax({
            url : $("#hidBASE_URL").val() + "index.php/" + ADMIN_CONTROLLER + "/deleteBoxoffice/"+id,
            type: "POST",
            dataType: "text",
