...
class Boxoffice_model extends CI_Model {

	var $table = 'boxoffice';

        var $column_order = array('Filmid','FilmName','Boxoffice','CreatedOn','Status'); //set column field database for datatable orderable
	var $column_search = array('FilmId','Status'); //set column field database for datatable searchable.
