...
class Film_model extends CI_Model {
	...
	var $table = 'film_tb';
        ...
        var $column_order = array('FilmName','Language','Category','Details','CreatedOn','Status'); //set column field database for datatable orderable
	var $column_search = array('FilmName','Status','UniqueName'); //set column field database for datatable searchable.
 ...
 function countFiltered()
	...
	public function deleteData($id)
	{
		...
		$this->db->delete('storyline',"FilmId = '$id'");
		$this->db->delete('cast_tb',"FilmId = '$id'");
		$this->db->delete('song_tb',"FilmId = '$id'");
		$this->db->delete('trailer_tb',"FilmId = '$id'");
		$this->db->delete('theater_tb',"FilmId = '$id'");
		$this->db->delete('boxoffice',"FilmId = '$id'");
                return TRUE;
	}
