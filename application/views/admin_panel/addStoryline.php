 ...
 <?php include 'header.php';?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <button class="btn btn-success" onClick="addData();"><i class="glyphicon glyphicon-plus"></i> Add StoryLine</button>
		...
		<small>* indicates required field.</small>
            ...
            <div class="modal-body form">
			 ...
			 <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="Film_Id" id="Film_Id" placeholder="Film Name" class="form-control required" required type="hidden" value="<?php echo $latestreleaseid?>" readonly>
                        ...
                        </div><input type="hidden" value="<?php echo $latestreleaseid?>" name="latestreleaseid" id="latestreleaseid" class="optional"/>
						
                       
                        
                       
                        <div class="form-group">
                            <label for="Discription" class="control-label col-md-3">Story</label>
                            <div class="col-md-9">
                            
								<textarea name="Story" id="Story" placeholder="Story" class="form-control required" required type="text"></textarea>
                                <span class="help-block"></span>
                            </div>
                        </div>
...
<script type="text/javascript" src="<?php echo base_url(); ?>js/admin/storyline.js"></script>
