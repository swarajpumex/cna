   ...
   <!-- Content Header (Page header) -->
	...
	<section class="content">
				...
				<form method="POST" action="" name ="add_form" id="add_form" role= "form" data-toggle="validator" data-disable="false" accept-charset="UTF-8" >
						...
						<div class="col-md-4">
							<input type="text" class="input-title form-control" id="head" name="head" style="width:300px; height:40px;"placeholder="Review Title" value="<?php echo $interview['Title'];?>"/>
						</div>
						<div class="col-md-5">
						...
						<div class="col-md-4">
							...
							<textarea  id="details" name="details" class="input-title form-control" placeholder="Details" rows="4" cols="50" maxlength="200" value="<?php echo $interview['Description'];?>"></textarea>
						...
						<!--<div class="form-group" id="hideWhenEdit">
                            ...
                            <div class="col-md-9">
                                <label class="btn btn-primary btn-file">
                                     Browse <input type="file"  accept="image/*" name="file" id="file" class="optional"
                                                   style='position:absolute;z-index:2;top:0;left:0;filter: 
                                                   alpha(opacity=0);-ms-filter:"progid:DXImageTransform.Microsoft.Alpha(Opacity=0)";
                                                   opacity:0;background-color:transparent;color:transparent;'
                                                   onchange="$('#upload-file-info').html($(this).val());">
		...
		function edit()
		{
			...
			$('#lanid').removeClass('has-error');
				...
				if(!hasErrors){
					...
					var URL ="<?php echo base_url();?>index.php/" +"/CinemaAd/editReviews/"+"<?php echo $interview['Id'];?>"
