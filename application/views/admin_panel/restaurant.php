 ...
 <?php include 'header.php';?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <button class="btn btn-success" onClick="addData();"><i class="glyphicon glyphicon-plus"></i> Add Restaurant</button>
                ...
                <form action="#" id="form" method="post" class="form-horizontal" enctype="multipart/form-data">
					...
					<div class="form-body">		
                        <div class="form-group">
                            <label for="Restaurant_name" class="control-label col-md-3">Name*</label>
                            <div class="col-md-9">
                                <input name="Restaurant_name" id="Restaurant_name" placeholder="Restaurant Name" class="form-control required" required type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        
                        <div class="form-group">
                            <label for="Restaurant_address" class="control-label col-md-3">Address*</label>
                            <div class="col-md-9">
                                <textarea name="Restaurant_address" id="Restaurant_address" placeholder="Address" class="form-control required"></textarea>
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
						 ...
						 <div class="form-group">
                            <label for="License_nbr" class="control-label col-md-3">License Number*</label>
                            <div class="col-md-9">
                                <input name="License_nbr" id="License_nbr" placeholder="License Number" class="form-control required" required type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
						 
						   <div class="form-group" id="hideWhenEdit">
                            <label for="userfile" class="control-label col-md-3">Certificate</label>
                            <div class="col-md-9">
...
<script type="text/javascript" src="<?php echo base_url(); ?>js/admin/restaurant.js"></script>
