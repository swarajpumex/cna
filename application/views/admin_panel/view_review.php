        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"> View Review List</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
<script type="text/javascript" src="<?php echo base_url(); ?>js/admin/review.js"></script>
