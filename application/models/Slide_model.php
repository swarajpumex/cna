...
class Slide_model extends CI_Model {
	...
	var $table = 'slide_tb';
        ...
        var $column_order = array('Id','SlideName','CreatedOn','Status'); //set column field database for datatable orderable
	var $column_search = array('Id','SlideName','Status'); //set column field database for datatable searchable.
