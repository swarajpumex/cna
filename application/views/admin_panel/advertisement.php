 ...
 <?php include 'header.php';?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <button class="btn btn-success" onClick="addData();"><i class="glyphicon glyphicon-plus"></i> Add Advertisement</button>
    ...
    <div class="modal-dialog">
		...
		<small>* indicates required field.</small>
			...
			<div class="form-group">
                            <label for="User_Id" class="control-label col-md-3">Title*</label>
                            <div class="col-md-9">
                                <input name="Name" id="Name" placeholder="Title" class="form-control required" required type="text">
                       ...
                       <div class="form-group" >
                            <label for="userfile" class="control-label col-md-3">Add Advertisement</label>
                            <div class="col-md-9">
                                <label class="btn btn-primary btn-file">
                                     Browse <input type="file"  accept="image/*" name="userfile" id="file" class="optional"
                      	...
                      	<div class="form-group">
                            <label for="Space" class="control-label col-md-3">Select Space</label>
                            <div class="col-md-9">
                                <select name="Space" id="Space" class="form-control">
                                    <option value="Homepage_up" selected="selected">Homepage-Up</option>
                                    <option value="Homepage_down">Homepage-Down</option>
                                    <option value="NewsList">NewsList page</option>
...
<script type="text/javascript" src="<?php echo base_url(); ?>js/admin/advertisement.js?v=1.000"></script>
