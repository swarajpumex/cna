                ...
                <form action="#" id="form" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label for="Category" class="control-label col-md-3">Category Name*</label>
                            <div class="col-md-9">
                                <input name="Category" id="Category" placeholder="Category Name" class="form-control required" required type="text">
...
<script type="text/javascript" src="<?php echo base_url(); ?>js/admin/courses-categories.js"></script>
