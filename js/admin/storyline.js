...
var save_method; //for save method string
    ...
    table = $('#dataTable').DataTable({ 
        ...
        "ajax": {
            "url": BASE_URL + "index.php/" + ADMIN_CONTROLLER +"/storylineList/" +latestreleaseid, //<?php echo site_url('person/ajax_list')?>
            "type": "POST",
...
{
    var EDIT_URL  =  $("#hidBASE_URL").val() + "index.php/" + ADMIN_CONTROLLER + "/getEditStory";
    ...
    $.ajax({
	    ...
	    $('[name="hidID"]').val(data.Id);
           ...
           // $('[name="Retype_Password"]').val("xxxxxxxxxxxxxx");
            ...
            $('.modal-title').text('Edit StoryLine'); // Set title to Bootstrap modal title
...
var formUtils = {
    ...
    if(save_method == 'add') {
        ...
        url = $("#hidBASE_URL").val() + "index.php/" + ADMIN_CONTROLLER + "/saveStory";
    } 
...
function deleteData(id)
{
    ...
    bootbox.confirm({
        ...
        $.ajax({
            url : $("#hidBASE_URL").val() + "index.php/" + ADMIN_CONTROLLER + "/deleteStory/"+id,
            type: "POST",
            dataType: "text",
