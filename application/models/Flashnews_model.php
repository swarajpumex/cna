...
class Flashnews_model extends CI_Model {
	...
	var $table = 'flashnews';
        ...
        var $column_order = array('Flashnews','CreatedOn','Status'); //set column field database for datatable orderable
	var $column_search = array('Flashnews','Status'); //set column field database for datatable searchable.
