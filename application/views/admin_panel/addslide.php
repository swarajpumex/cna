 ...
 <?php include 'header.php';?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <button class="btn btn-success" onClick="addData();"><i class="glyphicon glyphicon-plus"></i>  Add Slide Image</button>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Slide Image List</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <form action="#" id="form" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
						...
						<div class="form-group">
                            <label for="Slide_Name" class="control-label col-md-3">Slide Name*</label>
                            <div class="col-md-9">
                                <input name="Slide_Name" id="Slide_Name" placeholder="Slide Name" class="form-control required" required type="text">
...
<script type="text/javascript" src="<?php echo base_url(); ?>js/admin/addslide.js"></script>
