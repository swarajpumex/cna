   ...
   <!-- Content Header (Page header) -->
	...
	<section class="content">
				...
				<form method="POST" action="" name ="add_form" id="add_form" role= "form" data-toggle="validator" data-disable="false" accept-charset="UTF-8" >
						...
						<div class="col-md-4">
							<input type="text" class="input-title form-control" id="head" name="head" style="width:300px; height:40px;"placeholder="Interview Title"/>
						</div>
						<div class="col-md-5">
						...
						<div class="col-md-5">
                            ...
                            <div class="col-md-7">
                               <input name="UniqueName" id="UniqueName" placeholder="Unique Name" class="form-control required" required type="text" style="width:200px; height:40px;">
		...
		function edit()
		{
			...
			$('#lanid').removeClass('has-error');
				...
				if(!hasErrors){
					...
					var URL ="<?php echo base_url();?>index.php/" +"/CinemaAd/saveInterview";
