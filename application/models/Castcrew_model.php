...
class Castcrew_model extends CI_Model {

	var $table = 'cast_tb';

        var $column_order = array('Name','FilmName','Details','CreatedOn','Status'); //set column field database for datatable orderable
	var $column_search = array('Name','FilmName','Status'); //set column field database for datatable searchable.
