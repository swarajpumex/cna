...
var save_method; //for save method string
    ...
    table = $('#dataTable').DataTable({ 
        ...
        "ajax": {
            "url": BASE_URL + "index.php/" + ADMIN_CONTROLLER +"/slideList", //<?php echo site_url('person/ajax_list')?>
            "type": "POST",
...
{
    var EDIT_URL  =  $("#hidBASE_URL").val() + "index.php/" + ADMIN_CONTROLLER + "/getEditSlide";
...
var formUtils = {
    ...
    if(save_method == 'add') {
        ...
        url = $("#hidBASE_URL").val() + "index.php/" + ADMIN_CONTROLLER + "/saveSlide";
    } 
...
function deleteData(id)
{
    ...
    bootbox.confirm({
        ...
        $.ajax({
            url : $("#hidBASE_URL").val() + "index.php/" + ADMIN_CONTROLLER + "/deleteSlide/"+id,
            type: "POST",
            dataType: "text",
