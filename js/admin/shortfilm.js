    ...
    table = $('#dataTable').DataTable({ 
     ...
     "ordering": true,
      ...
      // Load data for the table's content from an Ajax source
        "ajax": {
            "url": BASE_URL + "index.php/" + ADMIN_CONTROLLER +"/ShortfilmList", //<?php echo site_url('person/ajax_list')?>
            "type": "POST",
...
function deleteData(id)
{
    ...
    bootbox.confirm({
      ...
      callback: function (result) {
        ...
        $.ajax({
            url : $("#hidBASE_URL").val() + "index.php/" + ADMIN_CONTROLLER + "/deleteShortfilm/"+id,
            type: "POST",
            dataType: "text",
