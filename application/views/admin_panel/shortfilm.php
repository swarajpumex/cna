 ...
 <?php include 'header.php';?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <button class="btn btn-success" onClick="addData();"><i class="glyphicon glyphicon-plus"></i>   Add Shortfilm </button>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Shortfilm  List</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Add Shortfilm</h3>
                ...
                <form action="#" id="form" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="Film_Name" id="Film_Name" placeholder="Film Name" class="form-control required" required type="text" value="" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <textarea name="Details" id="Details" placeholder="Details" class="form-control required" required></textarea>
                                <span class="help-block"></span>
                            </div>
                        </div>
                        
          <div class="form-group">
                            <label for="Trailer Link" class="control-label col-md-3">Shortfilm Link*</label>
                            <div class="col-md-9">
          <input type="text" id="URL" name="URL" class="form-control required" placeholder="Youtube Short URL eg : https://youtu.be/Blb64VibSeE" required="" >
...
<script type="text/javascript" src="<?php echo base_url(); ?>js/admin/shortfilm.js"></script>
