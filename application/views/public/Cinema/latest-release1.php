			  ...
			  <div class="container-fluid">
			    <div class="col-md-12 text-center">
					...
					<?php foreach($lan as $value){?>
					  <li>
						<a class="nav-link" id="showall-tab" data-toggle="pill" href="#<?php echo $value['Language'];?>" role="tab" aria-controls="<?php echo $value['Language'];?>" aria-selected="true"><?php echo $value['Language'];?></a>
					</li><?php } ?>
					  <li>
						<a class="nav-link" id="Cars-tab" data-toggle="pill" href="#Cars" role="tab" aria-controls="Cars" aria-selected="false">Hindi</a>
					  </li>
					  <!--<li>
...
<?php foreach($film as $val) {?>
	    <div class="tab-pane fade show active" id="<?php echo $val['Language'];?>" role="tabpanel" aria-labelledby="showall-tab">
		    <div class="row justify-content-md-center"> 
